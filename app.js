...
const createNewTaskElement = function (taskString) {
  ...
  listItem.classList.add("task__item", "item");

  //input (checkbox)
  const checkBox = document.createElement("input"); //checkbx
  checkBox.classList.add("task__input", "input", "input-checkbox");
  //label
  const label = document.createElement("label"); //label
  label.classList.add("task__label", "label", "label-text");
  //input (text)
  const editInput = document.createElement("input"); //text
  editInput.classList.add("task__input", "input", "input-text");
  //button.edit
  const editButton = document.createElement("button"); //edit button
  editButton.classList.add("task__button", "button", "button-edit");

  //button.delete
  const deleteButton = document.createElement("button"); //delete button
  deleteButton.classList.add("task__button", "button", "button-delete");
  const deleteButtonImg = document.createElement("img"); //delete button image
  deleteButtonImg.classList.add("task__image", "image", "image-delete");
...
const editTask = function () {
  ...
  const containsClass = listItem.classList.contains("item-edit");
